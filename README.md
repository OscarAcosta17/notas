...
### [v1.1.5] - Exportación de Horario Inteligente (Hotfix)
**Fecha**: Julio 2026

**📦 Enlace de Descarga:** [NotasApp-v1.1.5.apk](https://github.com/OscarAcosta17/notas/releases/download/v1.1.5/NotasApp-v1.1.5.apk)

**Novedades y Características:**
- **Manejo de Topes de Horario**: La imagen exportada del horario ahora divide las casillas inteligentemente si existen múltiples clases chocando en la misma hora, evitando que se superpongan visualmente.
- **Formato Visual Mejorado**: Las clases en el cuadro exportado cuentan con un nuevo y elegante diseño tipográfico (Paralelo arriba a la izquierda, Nombre de la asignatura en el centro, y Sala abajo a la derecha).
