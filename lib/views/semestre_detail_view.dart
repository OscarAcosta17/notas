...
class SemestreDetailView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(semestre.nombre, style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        backgroundColor: Colors.white,
        elevation: 0,
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(ramo.nombre, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 18, color: Colors.black87)),
                    subtitle: Text('Promedio: ${ramo.tipoPromedio} - Apruébase con: ${ramo.notaAprobacion}', style: const TextStyle(color: Colors.black54)),
